...
description: Rewrite engineer-to-engineer updates for leadership (VP/director/PM/exec) shaped for Slack, JIRA, email, standup, or talking points. Use when asked for exec summary, status update, or less-jargony channel rewrite.
---
